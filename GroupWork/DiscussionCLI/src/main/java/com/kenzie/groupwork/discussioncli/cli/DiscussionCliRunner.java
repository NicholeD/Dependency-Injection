...
//    private static ATAUserInput userHandler;
    ...
    public static void main(String[] args) {
        ...
        ViewTopicsHandler viewTopicsHandler = dagger.provideViewTopicsHandler();
        ViewTopicMessagesHandler viewTopicMessagesHandler = dagger.provideViewTopicMessageHandler();
        CreateTopicMessageHandler createTopicMessageHandler = dagger.provideCreateTopicMessageHandler();
        LoginHandler loginHandler = dagger.provideLoginHandler();
        CreateTopicHandler createTopicHandler = dagger.provideCreateTopicHandler();
        ChangeTopicHandler changeTopicHandler = dagger.provideChangeTopicHandler();
        ATAUserInput userHandler = dagger.provideATAUserInput();
        ExitHandler exitHandler = dagger.provideExitHandler();
